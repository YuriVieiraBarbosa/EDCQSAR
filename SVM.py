...
plt.title(
    f"SVR Híbrido (R²={r2:.3f})"
)

plt.tight_layout()

plt.savefig(
    "SVR_hybrid_real_vs_predito.png",
    dpi=300
)
...
plt.savefig(
    "SVR_hybrid_histograma_erros.png",
    dpi=300
)
...
print("SVR_hybrid_real_vs_predito.png")
print("SVR_hybrid_histograma_erros.png")
print("SVR_hybrid_residuos.png")